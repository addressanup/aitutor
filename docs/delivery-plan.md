...
17. **Spike acceptance bars:** one criterion per spike, stated identically in Phase 0 and the task cards (AX: ≥17/20 over a median of ≥3 runs, 16–18 UNDECIDED; snapshot: 50/0/p95-in-window on ≥2 Macs).
